...
namespace PCL
{
	public class FormsPage : ContentPage
	{
		...
		public List<FormTable5> SubmittedFormsList = new List<FormTable5>();
		...
		async Task AddForm()
		{
			...
			try
			{
				...
				var form = await App.azureService.AddForm("Firstname","Lastname",definition.Title,formvalues);

				SubmittedFormsList.Add(form);
